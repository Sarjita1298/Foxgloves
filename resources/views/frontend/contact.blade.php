...
<!-- STAFFING SECTION -->
<section class="turnkey_section my-5" style="background-image: url('{{ asset('frontend/images/railways1.png') }}');">
  <div class="overlay"></div>

  <div class="container text-center p-4 content-wrapper">
...
<!-- TURNKEY SECTION -->
<section class="turnkey_section my-5" style="background: url('{{ asset('frontend/images/railways1.png') }}') center center / cover no-repeat;">
  <div class="overlay"></div>
