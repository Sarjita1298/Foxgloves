...
<div class="hero_area">
  ...
  <header class="header_section"  id="headertop">
      ...
      <nav class="navbar navbar-expand-lg custom_nav-container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="quote_btn-container" style="max-width: 200px; margin: 0 auto;">
            <a href="{{ route('index') }}" class="quote_btn">
              Get A Quote
            </a>
          </div>
        </div>
...
<div class="service-dropdown-wrapper">
  ...
  <ul class="dropdown-menu custom-dropdown-menu" aria-labelledby="serviceDropdown">
    ...
    <li><a class="dropdown-item" href="{{ route('index') }}">Our Company</a></li>
    <li><a class="dropdown-item" href="{{ route('training_development') }}">Training</a></li>
    <li><a class="dropdown-item" href="{{ route('index') }}">Industry</a></li>
    <li><a class="dropdown-item" href="{{ route('index') }}">Special Unit</a></li>
